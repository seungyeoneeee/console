        ...
        >
            ...
            >
                <template #data-budgetPlan="{ data }">
                    <div class="budget-plan-wrapper"
                         :class="{isEditing: state.budgetEdit}"
                    >
                        <p-pane-layout v-if="budgetData?.time_unit === 'MONTHLY'"
                                       class="budget-plan-monthly-wrapper"
                                       :class="{'budget-plan-monthly-editable': state.budgetEdit}"
                        >
