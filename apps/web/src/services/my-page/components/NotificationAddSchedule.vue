...
const emit = defineEmits<{(event: 'change', payload: ScheduleSettingFormType): void;
}>();
...
const state = reactive({
    ...
    scheduleSettingTypeData: {} as ScheduleSettingFormType,
...
const emitChange = () => {
    emit('change', state.scheduleSettingTypeData);
...
const handleScheduleForm = (value: ScheduleSettingFormType) => {
    state.scheduleSettingTypeData = value;
    emitChange();
};
